  ...
  return (
    <>
      ...
      <div className="  flex justify-center  flex-col text-center h-[100vh] bg-[#edf0f6] ">
        <p className="font-extrabold text-transparent text-5xl  bg-clip-text bg-gradient-to-r from-red-400 to-gray-600 ">
        ...
        <div>
          <button
            onClick={handleExplore}
            className=" border-2 border-l-black border-b-black border-t-gray-600 border-r-gray-600 px-32  shadow mb-7 shadow-black text-2xl py-5 text-black font-semibold  w-fit"
          >
            Explore Now
          </button>
        </div>
